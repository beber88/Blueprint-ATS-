 ...
 * rows), so an O(n^2) pairwise comparison is fine and avoids a fuzzy-
 * matching dependency. Used by /api/hr/qc/duplicates.
 */
 ...
 * national id, employee code) or its names are highly similar.
 */
