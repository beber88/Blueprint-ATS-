...
// `normalize` is used by the INVALID_ATTENDANCE_STATUS rule, which compares
// against an allow-list — different shape from the master-data matcher
// (which lives in lib/shared/text-match.ts). Keep this minimal helper local.
