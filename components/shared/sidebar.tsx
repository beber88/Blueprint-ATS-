...
import {
  ...
  IdCard, Building2, Cloud, Receipt, Clock, FileSignature, Package, ShieldCheck, Award, BarChart3, CheckCircle2,
} from "lucide-react";
...
const navGroups: { labelKey: string; items: { key: string; href: string; icon: LucideIcon; adminOnly?: boolean }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "nav.payroll", href: "/payroll", icon: Receipt },
      { key: "nav.attendance", href: "/attendance", icon: Clock },
      ...
      { key: "nav.qc", href: "/qc", icon: CheckCircle2 },
