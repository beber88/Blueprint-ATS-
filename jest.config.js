...
module.exports = {
  ...
  // CI gate. If any file under lib/operations/ falls below these numbers
  // CI fails. Branches at 70 (not 80) because early-return / warning-path
  // branches tend to drift more than statement coverage on small PRs —
  // we'd rather the gate not cry wolf on a one-line bug fix.
  coverageThreshold: {
